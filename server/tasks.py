...
def dispatch_alert_notifications(
    ...
    config = {
        ...
        'smtp_tls': bool(current_app.config.get('ALERT_SMTP_TLS', False)),
        'smtp_ssl': bool(current_app.config.get('ALERT_SMTP_SSL', False)),
        ...
        'webhook_secret': current_app.config.get('ALERT_WEBHOOK_SECRET', ''),
